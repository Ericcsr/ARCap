...
namespace DepthAPISample
{
    ...
    public class EnvironmentDepthEnabler : MonoBehaviour
    {
        private void Start()
        {
            var depthTextureProvider = GetComponent<EnvironmentDepthTextureProvider>();
            if (depthTextureProvider != null)
            {
                ...
                depthTextureProvider.SetEnvironmentDepthEnabled(true);
            }
        }
    }
}
